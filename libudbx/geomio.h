...
typedef struct geom_consumer_t {
  ...
  int(*data)(const struct geom_consumer_t *consumer, const geom_header_t *header, size_t data_count, const char *pData, errorstream_t *error);
} geom_consumer_t;
...
void geom_consumer_init(
  ...
  int(*data)(const struct geom_consumer_t *, const geom_header_t *, size_t data_count, const char *, errorstream_t *)
);
